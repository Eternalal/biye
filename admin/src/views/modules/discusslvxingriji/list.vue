		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"width":"10%","margin":"0 0 20px 10px"}' :inline="true" :model="searchForm">
				...
				<el-row :style='{"margin":"10px 0","flexDirection":"column","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0","boxShadow":"0px 2px 6px 0px rgba(0,0,0,0.3020)","margin":"0 0 10px","outline":"none","borderRadius":"30px","width":"100%","fontSize":"14px","height":"40px"}' v-if="isAuth('discusslvxingriji','新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0","boxShadow":"0px 2px 6px 0px rgba(0,0,0,0.3020)","margin":"0 0 10px","outline":"none","borderRadius":"30px","width":"100%","fontSize":"14px","height":"40px"}' v-if="isAuth('discusslvxingriji','删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>
				</el-row>
			</el-form>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 4px 0","outline":"none","borderRadius":"30px", "width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('discusslvxingriji','修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 4px 0","outline":"none","borderRadius":"30px", "width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('discusslvxingriji','查看评论')" type="info" size="mini" @click="disscussListHandler(scope.row.id)">评论</el-button>
