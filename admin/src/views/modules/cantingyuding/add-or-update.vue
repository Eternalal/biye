	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="租赁价格" prop="yudingjiage">
					<el-input v-model="ruleForm.yudingjiage" placeholder="租赁价格" clearable  :readonly="ro.yudingjiage"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="租赁价格" prop="yudingjiage">
					<el-input v-model="ruleForm.yudingjiage" placeholder="租赁价格" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="租赁时间" prop="yudingshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.yudingshijian" label="预订时间" prop="yudingshijian">
					<el-input v-model="ruleForm.yudingshijian" placeholder="租赁时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="预订说明" prop="yudingshuoming">
					<el-input v-model="ruleForm.yudingshuoming" placeholder="租赁说明" clearable  :readonly="ro.yudingshuoming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="预订说明" prop="yudingshuoming">
					<el-input v-model="ruleForm.yudingshuoming" placeholder="租赁说明" readonly></el-input>
				</el-form-item>
